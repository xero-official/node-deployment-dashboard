...
const NodeMappingABI = "[{\"constant\":false,\"inputs\":[],\"name\":\"GetOwner\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"nodeAddress\",\"type\":\"address\"},{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"ip\",\"type\":\"string\"}],\"name\":\"CheckExistence\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"GetNodeCount\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"nodeAddress\",\"type\":\"address\"},{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"ip\",\"type\":\"string\"}],\"name\":\"AddNode\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"nodeAddress\",\"type\":\"address\"},{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"ip\",\"type\":\"string\"}],\"name\":\"RemoveNode\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"GetOperator\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"newOperator\",\"type\":\"address\"}],\"name\":\"SetOperator\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"name\":\"setCollateralRequirement\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"}]"

// NodeMappingBin is the compiled bytecode used for deploying new contracts.
const NodeMappingBin = ``
...
// GetNodeCount is a paid mutator transaction binding the contract method 0x70f2a971.
//
// Solidity: function GetNodeCount() returns(uint256)
func (_NodeMapping *NodeMappingTransactor) GetNodeCount(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _NodeMapping.contract.Transact(opts, "GetNodeCount")
}

// GetNodeCount is a paid mutator transaction binding the contract method 0x70f2a971.
//
// Solidity: function GetNodeCount() returns(uint256)
func (_NodeMapping *NodeMappingSession) GetNodeCount() (*types.Transaction, error) {
	return _NodeMapping.Contract.GetNodeCount(&_NodeMapping.TransactOpts)
}

// GetNodeCount is a paid mutator transaction binding the contract method 0x70f2a971.
//
// Solidity: function GetNodeCount() returns(uint256)
func (_NodeMapping *NodeMappingTransactorSession) GetNodeCount() (*types.Transaction, error) {
	return _NodeMapping.Contract.GetNodeCount(&_NodeMapping.TransactOpts)
}

// GetOperator is a paid mutator transaction binding the contract method 0xcededfb3.
//
// Solidity: function GetOperator() returns(address)
func (_NodeMapping *NodeMappingTransactor) GetOperator(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _NodeMapping.contract.Transact(opts, "GetOperator")
}

// GetOperator is a paid mutator transaction binding the contract method 0xcededfb3.
//
// Solidity: function GetOperator() returns(address)
func (_NodeMapping *NodeMappingSession) GetOperator() (*types.Transaction, error) {
	return _NodeMapping.Contract.GetOperator(&_NodeMapping.TransactOpts)
}

// GetOperator is a paid mutator transaction binding the contract method 0xcededfb3.
//
// Solidity: function GetOperator() returns(address)
func (_NodeMapping *NodeMappingTransactorSession) GetOperator() (*types.Transaction, error) {
	return _NodeMapping.Contract.GetOperator(&_NodeMapping.TransactOpts)
}

// GetOwner is a paid mutator transaction binding the contract method 0x0ae50a39.
//
// Solidity: function GetOwner() returns(address)
func (_NodeMapping *NodeMappingTransactor) GetOwner(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _NodeMapping.contract.Transact(opts, "GetOwner")
}

// GetOwner is a paid mutator transaction binding the contract method 0x0ae50a39.
//
// Solidity: function GetOwner() returns(address)
func (_NodeMapping *NodeMappingSession) GetOwner() (*types.Transaction, error) {
	return _NodeMapping.Contract.GetOwner(&_NodeMapping.TransactOpts)
}

// GetOwner is a paid mutator transaction binding the contract method 0x0ae50a39.
//
// Solidity: function GetOwner() returns(address)
func (_NodeMapping *NodeMappingTransactorSession) GetOwner() (*types.Transaction, error) {
	return _NodeMapping.Contract.GetOwner(&_NodeMapping.TransactOpts)
}
